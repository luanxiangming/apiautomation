...
import com.vipabc.msg.backend.configController.GiftCatalogListMsg;
...
public class GiftCatalogList extends Env{
	HttpFixture hf = new HttpFixture();
	@Test(priority = 1, dataProvider = "data", description = "")
	public void getGiftList(Map<String, String> dataDriven) {
		String token = AppLogin.login(hf, dataDriven.get("User"), dataDriven.get("Password"));
		hf.nextRequest();
		GiftCatalogListMsg.giftList(hf, token);
	...
	public Iterator<Object[]> data() {
		...
		return new ExcelProvider(this, "getGiftList");
	}
}
