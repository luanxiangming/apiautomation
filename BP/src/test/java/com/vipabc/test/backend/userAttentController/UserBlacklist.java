...
import com.vipabc.msg.backend.userAttentController.UserBlacklistMsg;
import com.vipabc.utils.Env;

import shelper.datadrive.ExcelProvider;
import shelper.iffixture.HttpFixture;

public class UserBlacklist  extends Env{
	HttpFixture hf = new HttpFixture();

	@Test(priority = 1, dataProvider = "data", description = "加入黑名单")
	public void createBlackList(Map<String, String> dataDriven) {
		String token = AppLogin.login(hf, dataDriven.get("User"), dataDriven.get("Password"));
		UserBlacklistMsg.blacklist(hf, token, dataDriven.get("uid"));
	...
	public Iterator<Object[]> data() {
		...
		return new ExcelProvider(this, "createBlackList");
	}
}
