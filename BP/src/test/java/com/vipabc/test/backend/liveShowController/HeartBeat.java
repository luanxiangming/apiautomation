...
import com.vipabc.msg.backend.liveShowController.HeartBeatMsg;
...
public class HeartBeat extends Env{
	HttpFixture hf = new HttpFixture();
	@Test(priority = 1, dataProvider = "data", description = "心跳")
	public void heartBeat(Map<String, String> dataDriven) {
		String token = AppLogin.login(hf, dataDriven.get("User"), dataDriven.get("Password"));
		HeartBeatMsg.hesrtBeat(hf, token, dataDriven.get("roomId"));
	...
	public Iterator<Object[]> data() {
		...
		return new ExcelProvider(this, "heartBeat");
	}
}
