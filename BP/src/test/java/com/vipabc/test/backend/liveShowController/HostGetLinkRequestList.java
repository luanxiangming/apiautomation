...
import com.vipabc.msg.backend.liveShowController.HostGetLinkRequestListMsg;
...
public class HostGetLinkRequestList extends Env{
	HttpFixture hf = new HttpFixture();
	@Test(priority = 1, dataProvider = "data", description = "")
	public void getRequestLink(Map<String, String> dataDriven) {
		String token = AppLogin.login(hf, dataDriven.get("User"), dataDriven.get("Password"));
		HostGetLinkRequestListMsg.getLinkRequest(hf, token, dataDriven.get("roomId"));
	...
	public Iterator<Object[]> data() {
		...
		return new ExcelProvider(this, "getRequestLink");
	}
}
