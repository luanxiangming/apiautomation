...
import com.vipabc.msg.backend.configController.GetInactiveGiftCatalogListMsg;
...
public class GetInactiveGiftCatalogList extends Env{
	HttpFixture hf = new HttpFixture();
	@Test(priority = 1, dataProvider = "data", description = "")
	public void getInactiveGift(Map<String, String> dataDriven) {
		String token = AppLogin.login(hf, dataDriven.get("User"), dataDriven.get("Password"));
		hf.nextRequest();
		GetInactiveGiftCatalogListMsg.giftCatalog(hf,token);		
	...
	public Iterator<Object[]> data() {
		...
		return new ExcelProvider(this, "getInactiveGift");
	}
}
