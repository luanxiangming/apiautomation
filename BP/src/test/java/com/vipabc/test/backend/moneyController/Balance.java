package com.vipabc.test.backend.moneyController;
...
import com.vipabc.msg.backend.moneyController.BalanceMsg;
import com.vipabc.utils.Env;

import shelper.datadrive.ExcelProvider;
import shelper.iffixture.HttpFixture;

public class Balance extends Env{
	HttpFixture hf = new HttpFixture();
	@Test(priority = 1, dataProvider = "data", description = "查询用户的账目")
	public void balance(Map<String, String> dataDriven) {
		String token = AppLogin.login(hf, dataDriven.get("User"), dataDriven.get("Password"));
		BalanceMsg.getBalance(hf, token);
	...
	public Iterator<Object[]> data() {
		...
		return new ExcelProvider(this, "balance");
	}
