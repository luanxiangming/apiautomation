...
import com.vipabc.msg.backend.liveShowController.FollowedOnliveListMsg;
...
public class FollowedOnliveList extends Env{
	HttpFixture hf = new HttpFixture();
	@Test(priority = 1, dataProvider = "data", description = "")
	public void followedOnlive(Map<String, String> dataDriven) {
		String token = AppLogin.login(hf, dataDriven.get("User"), dataDriven.get("Password"));
		FollowedOnliveListMsg.followedOnlive(hf, token, dataDriven.get("pageNo"), dataDriven.get("pageSize"));
	...
	public Iterator<Object[]> data() {
		...
		return new ExcelProvider(this, "followedOnlive");
	}
}
