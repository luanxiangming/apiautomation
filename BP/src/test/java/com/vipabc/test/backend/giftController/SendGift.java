...
import com.vipabc.msg.backend.giftController.SendGiftMsg;
...
public class SendGift extends Env{
	HttpFixture hf = new HttpFixture();
	@Test(priority = 1, dataProvider = "data", description = "")
	public void sendGift(Map<String, String> dataDriven) {
		String token = AppLogin.login(hf, dataDriven.get("User"), dataDriven.get("Password"));
		hf.nextRequest();
		SendGiftMsg.senfGift(hf, token,dataDriven.get("client_language"),dataDriven.get("giftId"),dataDriven.get("num"),dataDriven.get("roomId"),dataDriven.get("timestamp"));
	...
	public Iterator<Object[]> data() {
		...
		return new ExcelProvider(this, "sendGift");
	}
}
