...
import com.vipabc.msg.backend.courseDetailController.GetCourseListMsg;
...
public class GetCourseList extends Env{
	HttpFixture hf = new HttpFixture();
	@Test(priority = 1, dataProvider = "data", description = "")
	public void getCourseList(Map<String, String> dataDriven) {
		String token = AppLogin.login(hf, dataDriven.get("User"), dataDriven.get("Password"));
		hf.nextRequest();
		GetCourseListMsg.getCourseList(hf, token, dataDriven.get("client_language"));
	...
	public Iterator<Object[]> data() {
		...
		return new ExcelProvider(this, "getCourseList");
	}
}
