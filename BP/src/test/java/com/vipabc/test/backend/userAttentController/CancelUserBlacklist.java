...
public class CancelUserBlacklist extends Env{
	HttpFixture hf = new HttpFixture();
	@Test(priority = 1, dataProvider = "data", description = "移除黑名单")
	public void cancelBlack(Map<String, String> dataDriven) {
	...
	public Iterator<Object[]> data() {
		...
		return new ExcelProvider(this, "cancelBlack");
	}
}
