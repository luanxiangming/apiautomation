...
import com.vipabc.msg.backend.configController.GetGiftCatalogMsg;
import com.vipabc.msg.backend.courseDetailController.SubscriptionCourseMsg;
...
public class SubscriptionCourse extends Env{
	HttpFixture hf = new HttpFixture();
	@Test(priority = 1, dataProvider = "data", description = "")
	public void subscriptionCourse(Map<String, String> dataDriven) {
		String token = AppLogin.login(hf, dataDriven.get("User"), dataDriven.get("Password"));
		hf.nextRequest();
		SubscriptionCourseMsg.subscriptionCourse(hf, token);
		GetGiftCatalogMsg.giftCatalog(hf, token, dataDriven.get("id"));
	...
	public Iterator<Object[]> data() {
		...
		return new ExcelProvider(this, "subscriptionCourse");
	}
}
