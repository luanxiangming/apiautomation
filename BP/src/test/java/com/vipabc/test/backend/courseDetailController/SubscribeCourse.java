...
import com.vipabc.msg.backend.courseDetailController.SubscribeCourseMsg;
...
public class SubscribeCourse extends Env{
	HttpFixture hf = new HttpFixture();
	@Test(priority = 1, dataProvider = "data", description = "")
	public void subscribeCourse(Map<String, String> dataDriven) {
		String token = AppLogin.login(hf, dataDriven.get("User"), dataDriven.get("Password"));
		hf.nextRequest();
		SubscribeCourseMsg.giftCatalog(hf, dataDriven.get("id"), token);
	...
	public Iterator<Object[]> data() {
		...
		return new ExcelProvider(this, "subscribeCourse");
	}
}
