...
import com.vipabc.msg.backend.courseDetailController.GetlessonsByCourseIdMsg;
...
public class GetlessonsByCourseId extends Env{
	HttpFixture hf = new HttpFixture();
	@Test(priority = 1, dataProvider = "data", description = "")
	public void getlessons(Map<String, String> dataDriven) {
		String token = AppLogin.login(hf, dataDriven.get("User"), dataDriven.get("Password"));
		hf.nextRequest();
		GetlessonsByCourseIdMsg.getlessonsByCourseId(hf, token, dataDriven.get("courseId"));
	...
	public Iterator<Object[]> data() {
		...
		return new ExcelProvider(this, "getlessons");
	}
}
