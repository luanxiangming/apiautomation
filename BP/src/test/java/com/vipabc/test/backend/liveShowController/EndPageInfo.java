...
import com.vipabc.msg.backend.liveShowController.EndPageInfoMsg;
...
public class EndPageInfo extends Env{
	HttpFixture hf = new HttpFixture();
	@Test(priority = 1, dataProvider = "data", description = "")
	public void endPageInfo(Map<String, String> dataDriven) {
		...
		EndPageInfoMsg.endPage(hf, token, roomId);
	...
	public Iterator<Object[]> data() {
		...
		return new ExcelProvider(this, "endPageInfo");
	}
}
