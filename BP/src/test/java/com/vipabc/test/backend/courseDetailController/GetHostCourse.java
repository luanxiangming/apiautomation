...
import com.vipabc.msg.backend.courseDetailController.GetHostCourseMsg;
...
public class GetHostCourse extends Env{
	HttpFixture hf = new HttpFixture();
	@Test(priority = 1, dataProvider = "data", description = "")
	public void getHostCourse(Map<String, String> dataDriven) {
		String token = AppLogin.login(hf, dataDriven.get("User"), dataDriven.get("Password"));
		hf.nextRequest();
		GetHostCourseMsg.getHostCourse(hf, token,  dataDriven.get("client_language"));
	...
	public Iterator<Object[]> data() {
		...
		return new ExcelProvider(this, "getHostCourse");
	}
}
