...
import com.vipabc.msg.backend.liveShowController.HasPermissionMsg;
...
public class HasPermission extends Env{
	HttpFixture hf = new HttpFixture();
	@Test(priority = 1, dataProvider = "data", description = "是否有直播权限")
	public void hasPermission(Map<String, String> dataDriven) {
		String token = AppLogin.login(hf, dataDriven.get("User"), dataDriven.get("Password"));
		HasPermissionMsg.hasPermission(hf, token);
	...
	public Iterator<Object[]> data() {
		...
		return new ExcelProvider(this, "hasPermission");
	}
}
