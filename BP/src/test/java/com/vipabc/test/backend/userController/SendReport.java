...
import com.vipabc.msg.backend.userController.SendReportMsg;
import com.vipabc.utils.Env;

import shelper.datadrive.ExcelProvider;
import shelper.iffixture.HttpFixture;

public class SendReport extends Env{
	HttpFixture hf = new HttpFixture();

	@Test(priority = 1, dataProvider = "data", description = "举报用户")
	public void sendReport(Map<String, String> dataDriven) {
		String token = AppLogin.login(hf, dataDriven.get("User"), dataDriven.get("Password"));
		SendReportMsg.sendReport(hf, token, dataDriven.get("uid"));
	...
	public Iterator<Object[]> data() {
		...
		return new ExcelProvider(this, "sendReport");
	}
}
