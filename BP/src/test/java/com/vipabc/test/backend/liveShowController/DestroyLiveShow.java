...
import com.vipabc.msg.backend.liveShowController.DestroyLiveShowMsg;
...
public class DestroyLiveShow extends Env{
	HttpFixture hf = new HttpFixture();
	@Test(priority = 1, dataProvider = "data", description = "结束直播间")
	public void destroy(Map<String, String> dataDriven) {
		...
		DestroyLiveShowMsg.destroyLiveshow(hf, roomId, token);
	...
	public Iterator<Object[]> data() {
		...
		return new ExcelProvider(this, "destroy");
	}
}
