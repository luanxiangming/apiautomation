...
import com.vipabc.msg.backend.courseDetailController.GetUserCourseMsg;
...
public class GetUserCourse extends Env{
	HttpFixture hf = new HttpFixture();
	@Test(priority = 1, dataProvider = "data", description = "")
	public void getUserCourse(Map<String, String> dataDriven) {
		String token = AppLogin.login(hf, dataDriven.get("User"), dataDriven.get("Password"));
		hf.nextRequest();
		GetUserCourseMsg.getUserCourse(hf, token);
	...
	public Iterator<Object[]> data() {
		...
		return new ExcelProvider(this, "getUserCourse");
	}
}
